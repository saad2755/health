...
THEMES = {
    "Sommeil": {
        "fichier": os.path.join(DOCS_DIR, "mieux-dormir-inpes.pdf"),
        "description": {
    ...
    "Readaptation cardiaque": {
        "fichier": os.path.join(DOCS_DIR, "APA-readapt-cardiaque.pdf"),
        "description": {
    ...
    "Nutrition": {
        "fichier": os.path.join(DOCS_DIR, "Polycopié_cours_nutrition_HZ_2.pdf"),
        "description": {
...
TEXTES = {
    "fr": {
        ...
        "err_doc_intro": "Le fichier est introuvable. Placez vos 3 PDF dans le dossier :",
    ...
    "ar": {
        ...
        "err_doc_intro": "الملف غير موجود. يرجى وضع ملفات PDF في المجلد:",
    ...
    "dar": {
        ...
        "groq_key_label": "مفتاح Groq API",
        "err_doc_intro": "الملف مالقيناهش. حط ملفات PDF فالمجلد:",
